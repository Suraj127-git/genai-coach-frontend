      ...
      <Box className='flex-1 bg-background'>
        <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: 'center', alignItems: 'center' }} className='px-6 pt-8 pb-8'>
          <View style={{ width: imgH, height: imgH, borderRadius: imgH/2, overflow: 'hidden' }} className='bg-surface items-center justify-center shadow'>
            <Image source={require('../../assets/split_ai_scene_1.png')} resizeMode='cover' style={{ width: '80%', height: '80%' }} />
          </View>
          <View className='mt-5 px-3'>
            <Text className='text-center text-2xl font-bold'>Personalized Coaching</Text>
            <Text className='text-center mt-2 text-muted text-base'>Practice realistic scenarios with guidance tailored to your goals.</Text>
          </View>
        </ScrollView>
